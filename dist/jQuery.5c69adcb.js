...
jQuery.fn = jQuery.prototype = {
  ...
  find: function find(selector) {
    ...
    this.each(function (node) {
      ...
      array.push.apply(array, _toConsumableArray(elements2));
    });
  ...
  children: function children() {
    var array = [];
    this.each(function (node) {
      array.push.apply(array, _toConsumableArray(node.children)); // ...新语法相当于 array.push(node.children[0],node.children[0],node.children[1]..node.children[n])
    });
    return jQuery(array);
  },
  siblings: function siblings() {
    ...
    if (this.elements.length === 1) {
      var children = Array.from(this.elements[0].parentNode.children);
  ...
  index: function index() {
    if (this.elements.length === 1) {
      var siblings = Array.from(this.elements[0].parentNode.children);
  ...
  prev: function (_prev) {
    ...
    prev.toString = function () {
      return _prev.toString();
    };
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "8415" + '/');
